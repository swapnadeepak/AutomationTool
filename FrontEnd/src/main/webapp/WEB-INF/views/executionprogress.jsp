...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$('#continueBtnId').click(function(event) {
			$.get("updateProcessOnJsp", function(responseText) {
			});
		});
	});
</script>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="box" style="height: 380px;">
							...
							<h5 style="font-size: 15px; padding-left: 10px;">
								Please wait, execution of <font color="#1e5e14"><b>'${runPlanFileName}'</b></font>
								is in progress.
							</h5>
							<%-- </c:if> --%>
							<%-- <c:if test="${resultstatus==100}">
							...
							<div class="box-body">
								...
								<c:if
									test="${resultstatus<100 && nodeMessage.trim().length() == 0}">
									<meta http-equiv="Refresh" content="5;url=process">
								</c:if>
								...
								<c:if test="${resultstatus<100}">
									...
									<c:if test='${nodeStatus.equals("Yes")}'>
										<c:if test='${stopStatus.equals("No")}'>
											...
											<div
												...
												<span id="stop" style="display: none;"><font
													color=red size=3px>Execution Terminates after
														current testcase execution completes.</font></span>
											</div>
										...
										<c:if test='${stopStatus.equals("Yes")}'>
											<div
												style="padding-left: 25px; width: 400px; text-align: center;">
												<h5 style="color: red">${stopMessage}</h5>
											</div>
											<form action="display" method="post">
												<input type="hidden" value="${resultfile}"
													name="fileLocation">
									...
									<c:if test='${nodeStatus.equals("No")}'>
										...
										<div
											style="padding-left: 25px; width: 400px; text-align: center;">
											<h5 id="msgId" style="color: red">
												<strong>${nodeMessage}</strong>
											</h5>
										</div>
										<div
											style="padding-left: 25px; width: 400px; text-align: center;">
											<form action="generate" method="post">
												...
												<div>
													<input type="submit" id="continueBtnId" value="Continue">
												</div>
											</form>
										</div>
									</c:if>
