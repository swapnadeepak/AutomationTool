...
<meta
	...
	name="viewport">
<title>${appTitle} | Add Admin</title>
<link rel="stylesheet"
...
<body class="hold-transition skin-blue sidebar-mini">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="row" class="content-wrapper">
					<div class="col-xs-12">
						<form action="saveAdmin" method="post" name="adminForm"
							onsubmit="return adminValidator();">
							<div class="box" style="height: 472px; overflow-y: auto;overflow-x:hidden ">
								...
								<table id="example1" class="table table-bordered table-striped">
									...
									<tr>
										...
										<td><input type="text" name="firstName"
											autofocus="autofocus" onkeydown="eraseMsg()"
											onkeyup="checkFirstName()" style="width: 200px;"></td>
									...
									<tr>
										...
										<td><input type="text" name="lastName"
											onkeyup="checkLastType()" style="width: 200px;"></td>
										<td><div id="lnError" style="color: red; font-size: 13px"></div></td>
									</tr>

									<tr>
										<td style="padding-right: 8px; width: 225px;">Username :</td>
										<td><input type="text" name="userName"
											onkeyup="checkUserName()" style="width: 200px;"></td>
									...
									<tr>
										...
										<td><input type="text" name="emailId" id="emailId"
											oninput="checkEmail()" style="width: 200px;"></td>
										<td><div id="mailError"
									...
									<tr>
										...
										<td><input type="password" name="password"
											style="width: 200px;" onkeyup="checkPwd()"></td>
										<td><div id="pwdError"
												style="color: red; font-size: 13px"></div></td>
									</tr>
									...
									<tr>
										...
										<td><input type="radio" name="status" value="active"
											...
											style="width: 50px; margin-left: -14px;"> Active<br>
											<input type="radio" name="status" value="inactive"
											onclick="checkStatus()"
											style="width: 50px; margin-left: -14px;"> In Active<br></td>
										<td><div id="statusError"
												style="color: red; font-size: 13px"></div></td>
									</tr>

									<tr>
										<td style="padding-right: 8px; width: 225px;">User Type:
										</td>
										<td><%-- <c:forEach items="${typeList}" var="userType">
												<c:if test="${userType.id eq  2}">
													<input type="text"
														value="<c:out value = "${userType.userTypeName}"/>" style="width: 200px;"
											...
											style="width: 200px;background-color: #e5dee4;"
											readonly="readonly">
											<input type="hidden" name="userType"
														value="<c:out value = "${userType.id}"/>">
									...
									<tr>
										...
										<td><select id="organization" name="organization"
											onclick="checkOrg()" style="width: 200px;"
								...
								<div class="row">
									...
									<div class="col-xs-1">
										<button type="button" id="right_All_1" class="btn btn-block" onclick="checkAssignGroup()">
											<i class="glyphicon glyphicon-forward"></i>
										</button>
										<button type="button" id="right_Selected_1" onclick="checkAssignGroup()"
											class="btn btn-block">
											<i class="glyphicon glyphicon-chevron-right"></i>
										</button>
										<button type="button" id="left_Selected_1" onclick="checkAssignGroup()"
											class="btn btn-block">
											<i class="glyphicon glyphicon-chevron-left"></i>
										</button>
										<button type="button" id="left_All_1" class="btn btn-block" onclick="checkAssignGroup()">
									...
									<div class="col-xs-3">
										<select name="assignedGroup" id="multiselect_to_1"
											...
											style="height: 145px">
												<c:forEach items="${availablegroupList}" var="availableGroup">
												<c:if test="${fn:toLowerCase(availableGroup.name) == 'admin group'}">
									...
									<div id="asGrpError"
										style="color: red; margin-left: 100px; font-size: 13px;padding-left: 660px;"></div>
								</div>
								<!-- <h6 style="color: blue">*Admin should have atleast one
									group.</h6> -->
								<div  align="center">
									<input type="submit" name="submit_bttn" id="submit_bttn"
										value="Create Admin" onclick="selectGrp(); return adminValidator();"
	...
	<!-- ./wrapper -->
	<script type="text/javascript" src="resources/js/adminvalidation.js"></script>
